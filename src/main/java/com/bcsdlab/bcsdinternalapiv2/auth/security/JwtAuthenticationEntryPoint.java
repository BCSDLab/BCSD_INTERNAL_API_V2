...
public class JwtAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response,
        ...
        ErrorResponse errorResponse = new ErrorResponse(AuthExceptionType.UNAUTHORIZED.getMessage());
        response.setStatus(AuthExceptionType.UNAUTHORIZED.getHttpStatus().value());
